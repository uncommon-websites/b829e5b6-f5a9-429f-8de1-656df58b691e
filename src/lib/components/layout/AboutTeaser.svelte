...
<script lang="ts">
	...
	name: "James SE",
	role: "Founder & CEO",
	image: "/generated/image-a-confident-male-in-his-mid-30s-with-a-p.webp"
};
</script>
...
<section bind:this={sectionRef} {...props}>
  ...
  text={`"Infrastructure is too important to move this slowly. Build started with one simple question: what if AI built faster than humans?"`}
/>
